...
vim.keymap.set("n", "<leader>nt", function()
    ...
    vim.api.nvim_buf_set_var(preview_buf, "buftype", "nofile")
    vim.api.nvim_buf_set_var(preview_buf, "bufhidden", "wipe")
    vim.api.nvim_buf_set_var(preview_buf, "swapfile", false)
    vim.api.nvim_buf_set_var(preview_buf, "modifiable", false)
    ...
    vim.api.nvim_buf_set_var(preview_buf, "modifiable", true)
